...
module.exports = function(grunt)
{
    ...
    grunt.registerMultiTask('smartsprites', '{%= description %}', function()
    {
        ...
        var cssFile = data.cssFile ? path.resolve(data.cssFile) : '';
        ...
        var command  =  ' --root-dir-path "' + rootPath + '" --output-dir-path "' + outputPath + '" --css-file-suffix ' + suffix;
        if(cssFile.length > 0)
        {
            command  = cmdPath + ' --css-files "' + cssFile + '"'  + command;
        }
        else
        {
